...
<html lang="NL">
    ...
    <header class="bg-pink h-50 text-center text-light font-bold text-5xl">Welcome to <p class="text-white">SONGS</p></header>
    ...
    <body class="bg-pastel text-center text-black">
       ...
       <h1 class="text-2xl font-medium">Songs:</h1>
        <br>
       <div class="grid list-disc text-xl mb-4 grid-rows-10 grid-cols-5">
